...
/// ! This implements as Binary Search Tree (BST), which is a
    ...
    T: Ord,
{
    ...
    /// Find a value in this tree. Returns Tree value is in this
    ...
    /// Returns a new iterator which iterates over this tre in order
...
T: Ord,
{
    ...
    pub fn stack_push_left(&mut self){
